  ...
  return (
    <div className="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 text-center">
      ...
      <div id="payment-status">
        ...
        {userCreated && (
          <p className="text-green-500 text-sm mb-6">A new user account has been created for you!</p>
        )}
        {userExists && (
        ...
        <Link
          href="/"
          id="retry-button"
          className="text-sky-600 hover:text-sky-700 text-sm font-medium inline-block transition-colors duration-200 mt-4"
        >
          Test another
        </Link>
      </div>
