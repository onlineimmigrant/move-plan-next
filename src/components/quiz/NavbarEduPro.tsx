...
export default function NavbarEduPro() {
  ...
  return (
    <nav
      className={`max-w-7xl mx-auto  fixed top-0 left-0  right-0  bg-transparent backdrop-blur-sm z-50 transition-opacity duration-300 ${
    ...
    >
      <div className="">
        <div className='flex justify-center items-center py-3 '>
         ...
         className="fixed left-4 hidden sm:block h-6 sm:h-8 w-auto" />
        <Image src={companyLogo} alt="Logo mobile" width={30} height={30} 
         className="fixed left-4 block sm:hidden h-6 sm:h-8 w-auto" />
         
         <div className="flex justify-center h-12 items-center">
          <div className="flex-shrink-0 flex items-center">
            <Link href={`/account/edupro/${slug}`}>
              <span className="text-lg sm:text-xl font-bold text-gray-900 relative ">
                {courseTitle}
