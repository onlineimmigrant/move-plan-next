...
export default function NavbarEduPro() {
  ...
  return (
    ...
    >
      <div className="">
        <div className='flex justify-start px-8 items-center py-3 '>
  
         
         <div className="flex justify-start h-12 items-center">
          <div className="flex-shrink-0 flex items-center">
            <Link href={`/account/edupro/${slug}`}>
              <span className="text-base sm:text-lg font-bold text-gray-900 relative ">
                {courseTitle}
          ...
          <div className="fixed right-8 flex items-center space-x-4">
