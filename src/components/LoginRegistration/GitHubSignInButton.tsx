...
export default function GitHubSignInButton({ onSuccess, redirectTo }: GitHubSignInButtonProps) {
  ...
  const handleGitHubSignIn = async () => {
    ...
    try {
      ...
      console.log('GitHub OAuth - final redirect URL stored:', finalRedirectUrl);
