      ...
      <div className="bg-white rounded-xl shadow-2xl max-w-md w-full">
        ...
        <div className="flex items-start justify-between px-6 py-4 border-b border-gray-200">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-gray-900">Remove or Delete Metric</h3>
            ...
            <>
              ...
              <div className="space-y-3">
                <button
                  ...
                  className="w-full text-left border-2 border-gray-200 rounded-lg p-4 hover:border-blue-400 hover:bg-blue-50 transition-colors group"
                >
                  <div className="flex items-start gap-3">
                    <div className="flex-shrink-0 w-8 h-8 rounded-full bg-blue-100 group-hover:bg-blue-200 flex items-center justify-center mt-0.5">
                ...
                <button
                  ...
                  className="w-full text-left border-2 border-gray-200 rounded-lg p-4 hover:border-red-400 hover:bg-red-50 transition-colors group"
                >
                  <div className="flex items-start gap-3">
