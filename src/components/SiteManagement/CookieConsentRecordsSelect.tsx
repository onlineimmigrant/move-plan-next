...
interface CookieConsentRecord {
  ...
  user_id?: string | null; // Now optional since anonymous users might not have user_id
  organization_id: string; // New field for direct organization linking
                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-1 text-xs text-gray-600">
                      ...
                      <span className="ml-3">Org: {record.organization_id.substring(0, 8)}...</span>
                      {record.ip_address && (
