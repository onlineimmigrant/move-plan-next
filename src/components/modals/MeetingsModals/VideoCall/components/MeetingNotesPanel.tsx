      ...
      {!isMinimized && (
        <>
          <textarea
            ...
            className="flex-1 p-4 bg-slate-900/50 text-slate-200 resize-none focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:bg-slate-800/50 rounded-none transition-all duration-200 text-sm leading-relaxed placeholder-slate-400 scrollbar-thin scrollbar-thumb-slate-600 scrollbar-track-transparent"
          />
          ...
          <div className="p-4 border-t border-slate-700/50 bg-slate-800/30 flex gap-3">
            <button
              ...
              className="flex-1 py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white rounded-xl text-sm font-medium shadow-lg transition-all duration-200 hover:scale-105 hover:shadow-blue-500/20"
            >
              Download Notes
            </button>
            <button
