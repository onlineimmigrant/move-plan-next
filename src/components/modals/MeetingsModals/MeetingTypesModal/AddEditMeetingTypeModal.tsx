          ...
          <div className="grid grid-cols-3 gap-2">
            {commonDurations.map((duration) => (
              <button
                ...
                style={{
                  borderColor: formData.duration_minutes === duration ? primary.base : '#e5e7eb',
                  backgroundColor: formData.duration_minutes === duration ? `${primary.base}1a` : 'white',
                  color: formData.duration_minutes === duration ? primary.active : '#374151'
                }}
                disabled={loading}
              >
                {duration} min
            ...
            {commonColors.map((color) => (
              <button
                ...
                style={{
                  ...
                  borderColor: formData.color === color.value ? '#1f2937' : '#d1d5db',
                  boxShadow: formData.color === color.value ? `0 0 0 2px ${primary.base}` : 'none'
                }}
                title={color.name}
                disabled={loading}
              />
