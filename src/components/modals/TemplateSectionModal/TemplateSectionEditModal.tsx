  ...
  const modalContent = (
    ...
    >
      ...
      {isMobile ? (
        ...
        <Rnd
          default={{
            x: (typeof window !== 'undefined' ? Math.max(0, (window.innerWidth - 1120) / 2) : 120),
            y: (typeof window !== 'undefined' ? Math.max(50, (window.innerHeight - 900) / 2) : 50),
        ...
        {openMenu === 'layout' && (
          <div className="bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 px-6 py-3.5">
            ...
            <div className="md:hidden space-y-4">
              {/* First Row - Permanent */}
              <div className="space-y-3">
                <QuickPicksSection formData={formData} setFormData={setFormData} breakpoint="sm" />
            ...
            <div className="hidden md:block lg:hidden space-y-4">
              {/* First Row - Permanent */}
              <div className="space-y-3">
                <QuickPicksSection formData={formData} setFormData={setFormData} breakpoint="md" />
            ...
            <div className="hidden lg:block">
              ...
              <div className="grid grid-cols-12 gap-3 items-end mb-4">
                <div className="lg:col-span-4">
                  <QuickPicksSection formData={formData} setFormData={setFormData} breakpoint="lg" />
                </div>
