...
import { TicketAttachment, isImageFile, getFileIcon, formatFileSize } from '@/lib/fileUpload';
      ...
      <div className="max-w-3xl mx-auto space-y-4">
        ...
        <div className="flex justify-start items-start">
          <div className="max-w-[80%]">
            <Tooltip
              content={`${getDisplayName(selectedTicket.full_name || null)}${selectedTicket.email ? ' • ' + selectedTicket.email : ''} • ${new Date(selectedTicket.created_at).toLocaleString()}`}
            >
                                ...
                                {isImageFile(attachment.file_type) && attachmentUrls[attachment.id] ? (
                                  ...
                                  <div className="relative group">
                                    <img
                                      ...
                                      onClick={() => onDownloadAttachment(attachment.file_path, attachment.file_name)}
                                    />
