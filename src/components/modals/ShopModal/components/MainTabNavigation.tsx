...
import { Package, Archive, CreditCard, Sparkles, DollarSign, Users, ShoppingCart } from 'lucide-react';

export type MainTab = 'products' | 'pricing-plans' | 'features' | 'inventory' | 'stripe' | 'customers' | 'orders';
...
export default function MainTabNavigation({
  ...
  const tabs = [
    ...
    { id: 'pricing-plans' as const, label: 'Pricing Plans', icon: DollarSign },
