          ...
          {tabs.map((tab) => {
            ...
            return (
              <button
                ...
                className={`relative px-2 sm:px-6 md:px-8 py-2.5 sm:py-3 rounded-xl text-xs sm:text-[15px] font-medium transition-all duration-150 ease-out antialiased tracking-[-0.01em] flex-1 whitespace-nowrap ${
                  isActive
                    ? 'text-gray-900'
