    ...
    <div className="my-6">
      <div className="flex flex-wrap justify-center items-center gap-4 space-y-2 sm:space-y-0 font-medium">
        ...
        <button
          ...
          className="w-full bg-teal-500 text-white py-3 px-6 rounded-md hover:bg-teal-600 focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 text-base font-bold transition-colors duration-300"
