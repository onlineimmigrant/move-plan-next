  ...
  return (
    <div className="relative group">
      {/* Collapsed sidebar (mobile + desktop) */}
            {/* Mobile narrow bar */}
      <div
        className="pt-20 z-0 fixed inset-y-0 left-14 w-14 bg-white border-gray-200 flex flex-col items-center py-4 gap-6 border-r"
      >
      ...
      <aside
        className={cn(
          "z-0 fixed w-full px-8 sm:px-0 sm:w-72 bg-white border-r border-gray-100 transition-transform duration-200 ease-in-out",
