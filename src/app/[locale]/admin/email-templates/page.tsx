/**
 * Email Templates Management Page (Admin)
 * Manages organization email templates using shared components and patterns
 */
...
export default function EmailTemplatesPage() {
  const { session, isAdmin, isLoading: authLoading, organizationId: contextOrgId } = useAuth();
  ...
  // Organization ID is already available from context, no need to fetch
  ...
  if (authLoading || (loading && !organizationId)) {
    return (
    ...
    <div className="container mx-auto py-8 px-4">
      ...
      <div className="mb-6">
        <EmailSearchInput
          ...
          placeholder="Search templates by subject, type, or category..."
        />
      </div>
