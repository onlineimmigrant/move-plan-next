      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-12">
          <div className="relative max-w-2xl mx-auto">
            ...
            <input
              type="text"
              placeholder="Search through our FAQ database..."
              value={searchQuery}
          ...
          {filteredFAQs.length > 0 ? (
                  ...
                  >
                    ...
                    {isLoading ? (
                      <>
                        ...
                        <span className="relative">Loading more questions...</span>
                      </>
                    ) : (
                      <>
                        <span className="relative">Load More Questions</span>
            ...
            <div className="text-center py-16">
              ...
              <h3 className="text-xl font-semibold text-gray-800 mb-2">
                {searchQuery ? 'No matching questions found' : 'No questions available'}
              </h3>
              <p className="text-gray-600 max-w-md mx-auto">
                {searchQuery 
                  ? 'Try adjusting your search terms or browse all available questions.' 
                  : 'Check back later as we continue to add more helpful information.'
                }
              </p>
              {searchQuery && (
                <button
