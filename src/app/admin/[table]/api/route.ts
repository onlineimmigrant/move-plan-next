...
export async function GET(req: NextRequest, { params }: { params: Promise<{ table: string }> }) {
  ...
  let columnDefaults: { [key: string]: any } = {};
  ...
  let foreignKeys: { [key: string]: { relatedTable: string; relatedColumn: string } } = {};
  ...
  let foreignKeyOptions: { [key: string]: { id: string; name: string }[] } = {};
